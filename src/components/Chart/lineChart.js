	...
	datasets: [
		{
			...
			data: [
				15321.5,
				parseFloat((36482.25 - 20678.56).toFixed(2)),
				parseFloat((37526.36 - 21785.65).toFixed(2)),
				parseFloat((38482.85 - 22564.55).toFixed(2)),
				parseFloat((39524.56 - 23898.6).toFixed(2)),
				parseFloat((39752.2 - 24785.65).toFixed(2)),
				parseFloat((41452.56 - 25789.61).toFixed(2)),
			],
		},
